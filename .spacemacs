...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(
                                      (meghanada :fetcher github :repo "gmopemope/meghanada-emacs")
                                      (groovy-mode :fetcher github :repo "Groovy-Emacs-Modes/groovy-emacs-mode")
                                      (gradle-mode :fetcher github :repo "gjacobono/emacs-gradle-mode")
                                      )
...
you should place you code here."
  ...
  (setq org-todo-keywords
        '((sequence "TODO(t!)" "WAITING(w@/!)" "|" "DONE(d!)" "DELEGATED(x@)")))
  ;; configure log entries to go into drawer
  (setq org-log-into-drawer t)

  ;; don't really like modeline separators i think
